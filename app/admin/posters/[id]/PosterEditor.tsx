...
import { ArrowLeft, Archive, Save, Trash2 } from "lucide-react";
...
export function PosterEditor({ poster }: { poster: Poster }) {
  ...
  async function remove() {
    if (!confirm("Archive this poster? Existing buyers will keep access.")) return;
