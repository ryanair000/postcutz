...
export default function NewPosterPage() {
  ...
  return <div>
    <header className="admin-header"><div><Link className="back-link" href="/admin/posters"><ArrowLeft size={15} /> Back to posters</Link><span className="eyebrow">New content</span><h1>Upload poster</h1><p>Upload one high-resolution original; PostCutz creates the watermarked preview automatically.</p></div></header>
    <form className="admin-form" onSubmit={submit}>
      ...
      <section className="admin-panel form-section"><h2>File</h2><div className="upload-grid"><label className="file-drop"><ImagePlus /><strong>Original poster</strong><span>JPG, PNG or WebP · at least 1080×1080 · max 4 MB</span><input name="original" type="file" accept="image/png,image/jpeg,image/webp" required /></label></div></section>
